...
<div id="content" class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-denied-status_id"><?php echo $entry_denied_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-expired-status_id"><?php echo $entry_expired_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-failed-status_id"><?php echo $entry_failed_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-pending-status_id"><?php echo $entry_pending_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-processed-status_id"><?php echo $entry_processed_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-refunded-status_id"><?php echo $entry_refunded_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-reversed-status_id"><?php echo $entry_reversed_status; ?></label>
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label" for="input-voided-status_id"><?php echo $entry_voided_status; ?></label>
      ...
      <div class="form-group">
      	...
      	<div class="col-sm-10">
			<select name="pp_standard_status" class="form-control">
